...
<div id="loginBlock"><form action="/saveDriver" method="post">
    ...
    <input type="text" name="mobileNumber" id="" placeholder="MobileNumber"><br>
    <label for="email">Enter your Email: &nbsp;</label>
    <input type="text" name="email" id="" placeholder="Email"><br>
    <label for="licenceNo">Enter the Licence Number: &nbsp;</label>
    <input type="text" name="licenceNo" id="" placeholder="LicenceNo"><br>
    <label for="password">Enter a Password: &nbsp;</label>
    <input type="password" name="password1" id="" placeholder="Password"><br>
    <label for="password">Confirm Password: &nbsp;</label>
    <input type="password" name="password2" id="" placeholder="Password"><br>
